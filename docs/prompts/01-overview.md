...
1. **High-level description**: Explains what Grove Flow is and its purpose as an LLM job orchestration platform
...
4. **Ecosystem Integration**: A dedicated H2 section explaining how Grove Flow fits into the Grove ecosystem and works with other tools like grove-meta, grove-context, and grove-hooks
