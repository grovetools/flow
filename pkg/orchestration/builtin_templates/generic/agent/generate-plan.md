---
description: "Generates a multi-step plan from a specification"
type: "oneshot"
output:
  type: "generate_jobs"
---
## Base Prompt (Generate Plan)
...
- Structure for LLM agent execution, providing sufficient detail for the agent to find relevant files and lines of code easily
- Split large features into multiple agent jobs if needed, but err on the side of smaller number of jobs
